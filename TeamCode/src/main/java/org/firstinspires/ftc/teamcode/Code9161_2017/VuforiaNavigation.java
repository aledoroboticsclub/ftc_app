...
/**
 * Created by jreynoldsstudent on 11/15/2017.
 */
...
//public class ConceptVuforiaNavigation
     ...
     */
        ...
        VuforiaTrackable leftTarget = relicVuMark.get(0);
        leftTarget.setName("LEFT");

        VuforiaTrackable centerTarget  = relicVuMark.get(1);
        centerTarget.setName("CENTER");

        //VuforiaTrackable rightTarget  = relicVuMark.get(2);
        //rightTarget.setName("RIGHT");
    ...
    */
        ...
        RobotLog.ii(TAG, "Blue Target=%s", format(centerTargetLocationOnField));
        ...
        //RobotLog.ii(TAG, "Blue Target=%s", format(rightTargetLocationOnField));
